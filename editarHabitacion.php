            ...
            <form id="miFormulario" action="habitaciones.php" method="POST" class="grid lg:grid-cols-3 lg:w-3/6 bg-color-azul-marino color-gris-crema font-bold p-32 rounded-3xl justify-center"  enctype="multipart/form-data">
                <div class="flex col-span-3 flex-col">
                    <div class='w-full flex text-center  justify-between items-center '>
                        ...
                        <input type="text" name="nombre" id="registro" value="<?php $habitacion['nombre']?>" placeholder="Escriba el número de habitación" class="border-2 border-black color-azul-marino">
                    </div>
                ...
                <div class="flex col-span-3 flex-col">
                    <div class='w-full flex text-center  justify-between items-center '>
                        ...
                        <input type="text" name="capacidad" id="registro" value="<?php $habitacion['capacidad']?>" placeholder="Escriba la capacidad de la habitación" class="mt-6 border-2 border-black color-azul-marino">
                    </div>
                    <div class="w-64 flex justify-between">
                ...
                <div class="flex col-span-3 flex-col">
                    <div class='w-full flex text-center  justify-between items-center '>
                        ...
                        <input type="text" name="precio" id="registro" value="<?php $habitacion['precio']?>" placeholder="Precio de la habitación por noche" class="mt-6 border-2 border-black color-azul-marino">
                    </div>
                    <div class="w-64 flex justify-between">
                ...
                <div class="flex col-span-3 flex-col">
                    <div class='w-full flex text-center  justify-between items-center '>
                        ...
                        <input type="text" name="descripcion" id="registro" value="<?php $habitacion['descripcion']?>" placeholder="Escriba la descripción de la habitación" class="mt-6 border-2 border-black color-azul-marino">
                    </div>
                    <div class="w-64 flex justify-between">
