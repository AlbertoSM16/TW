...
function navAnonimo(){
  echo '  <nav class="hidden lg:flex px-10 flex-col relative">
    <ul class="flex">
        <li class=" h-full relative transition-transform duration-500 hover:scale-105"><a href="añadirReserva.php" class="p-6 text-3xl color-dorado ">Añadir reserva</a></li>
...
function navAnonimoMovil(){
    echo '<nav id="menuMovil" class="transition-transform duration-1000 fixed left-0 w-full z-50 bg-color-gris-crema flex flex-col translate-x-full lg:hidden">
      <ul class="flex flex-col">
        <li class=" h-full relative transition-transform duration-500 hover:scale-105 p-6"><a href="añadirReserva.php" class="p-6 text-3xl color-dorado ">Añadir reservar</a></li>
