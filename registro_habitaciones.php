            ...
            <form id="miFormulario" action="habitaciones.php?vieneRegistro=si" method="POST" class="w-full grid lg:grid-cols-3 lg:w-3/6 bg-color-azul-marino color-gris-crema font-bold p-32 rounded-3xl justify-center"  enctype="multipart/form-data">
                ...
                <div class="flex col-span-3 flex-col">
                    <div class='flex-col w-full lg:flex-row flex text-center  justify-between items-center '>
                        ...
                        <input type="text" name="capacidad" id="registro" placeholder="Escriba la capacidad de la habitación" class=" mt-6 lg:mt-0 border-2 border-black color-azul-marino">
                    </div>
                    <div class="w-64 flex justify-between">
                ...
                <div class="flex col-span-3 flex-col">
                    <div class='flex-col w-full lg:flex-row flex text-center  justify-between items-center '>
                        ...
                        <input type="text" name="precio" id="registro" placeholder="Precio de la habitación por noche" class=" mt-6 lg:mt-0 border-2 border-black color-azul-marino">
                    </div>
                    <div class="w-64 flex justify-between">
                ...
                <div class="flex col-span-3 flex-col">
                    <div class='flex-col w-full lg:flex-row flex text-center  justify-between items-center '>
                        ...
                        <input type="text" name="descripcion" id="registro" placeholder="Escriba la descripción de la habitación" class=" mt-6 lg:mt-0 border-2 border-black color-azul-marino">
                    </div>
                    <div class="w-64 flex justify-between">
