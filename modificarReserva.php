        ...
        <form action="reservas.php" method="post" class="w-full grid lg:grid-cols-3 lg:w-3/6 bg-color-azul-marino color-gris-crema font-bold p-32 rounded-3xl justify-center"> 
            <div class="flex col-span-3 flex-col">
                <div class=' flex-col w-full lg:flex-row flex text-center  justify-between items-center '>
                    ...
                    <input type="number" id="num_pax" value="<?= $reserva[0]['num_pax'] ?>"name="num_pax" class="mt-6 border-2 border-black color-azul-marino" required><br><br>
                </div>
            ...
            <div class="flex col-span-3 flex-col">
                <div class=' flex-col w-full lg:flex-row flex text-center  justify-between items-center'> 
                    ...
                    <input class="mt-6 border-2 border-black color-azul-marino" type="date" value=<?= $reserva[0]['dia_entrada'] ?> id="dia_entrada" name="dia_entrada" required><br><br>
                </div>
                <div class="w-64 flex justify-between">
            ...
            <div class="flex col-span-3 flex-col">
                <div class=" flex-col w-full lg:flex-row flex text-center  justify-between items-center">
                    ...
                    <input class="mt-6 border-2 border-black color-azul-marino"  value="<?= $reserva[0]['dia_salida'] ?>" type="date" id="dia_salida" name="dia_salida" required><br><br>
                </div>
            ...
            <div class="text-center col-span-3 justify-center items-center   flex-col w-full lg:flex-row pt-16">
                <button type="submit" name="modificarReserva" value="<?php $reserva[0]['id_reserva'] ?>" class="text border-white border-2 p-3 bg-color-bronce-metalico rounded-full w-32 animate-pulse" id="boton">Realizar reserva</button>
            </div>
