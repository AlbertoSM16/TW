...
<main class ="pt-36 md:pt-56 lg:p-0">
    ...
    <section class="flex justify-center p-6">
        <form action="avisoReserva.php" method="post" class="w-full grid lg:grid-cols-3 lg:w-3/6 bg-color-azul-marino color-gris-crema font-bold p-32 rounded-3xl justify-center" novalidate> 
            ...
            <div class="text-center col-span-3 justify-center items-center   flex-col w-full lg:flex-row pt-16">
                <button type="submit" name="add_reserva_recepcion" class="text border-white border-2 p-3 bg-color-bronce-metalico rounded-full w-32 animate-pulse" id="boton">Realizar reserva</button>
            </div>
