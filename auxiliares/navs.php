...
function navRecepcionista(){
    ...
    echo '<nav class="hidden lg:flex px-10 flex-col relative">
            ...
            <button type="submit" name="editar_sesion" class="bg-color-azul-marino py-2 px-4 rounded border-white border-2 animate-pulse input-button">Editar Perfil</button>
            </form>
            ...
            <button type="submit" name="editar_sesion-" class="bg-color-azul-marino py-2 px-4 rounded border-white border-2 animate-pulse input-button">Cerrar sesión</button>
            </form>
...
function navAnonimoMovil(){
    echo '<nav id="menuMovil" class="transition-transform duration-1000 fixed left-0 w-full z-50 bg-color-gris-crema flex flex-col translate-x-full lg:hidden">
      <ul class="flex flex-col">
        <li class=" h-full relative transition-transform duration-500 hover:scale-105 p-6"><a href="reservas.php" class="p-6 text-3xl color-dorado ">Reservas</a></li>
